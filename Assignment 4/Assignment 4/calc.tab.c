...
#line 143 "calc.tab.c" /* yacc.c:358  */
...
{
  "$end", "error", "$undefined", "FLOAT", "PLUS", "MINUS", "DIV", "TIMES",
  "EOL", "OB", "CB", "SQRT", "LOG", "POW", "COMMA", "$accept", "Input",
  "expr", YY_NULLPTR
};
#endif
...
{
       9,    13,    19,    -5,    13,    13,    11,    12,    14,    50,
      -5,    -5,    -2,    13,    13,    13,    13,    13,    13,    13,
      -5,    -5,    29,    36,    24,     0,     0,    -5,    -5,    -5,
      -5,    13,    43,    -5
};
...
{
      11,    12,    16,    17,    18,    19,    18,    19,    21,    22,
      23,    24,    25,    26,    27,    28,     3,     1,     4,    10,
      13,    14,     5,    15,     6,     7,     8,    32,    16,    17,
      18,    19,     0,    16,    17,    18,    19,     0,    31,    29,
      16,    17,    18,    19,     0,     0,    30,    16,    17,    18,
      19,     0,     0,    33,    16,    17,    18,    19,    20
};

static const yytype_int8 yycheck[] =
{
       4,     5,     4,     5,     6,     7,     6,     7,    10,    13,
      14,    15,    16,    17,    18,    19,     3,     8,     5,     0,
       9,     9,     9,     9,    11,    12,    13,    31,     4,     5,
       6,     7,    -1,     4,     5,     6,     7,    -1,    14,    10,
       4,     5,     6,     7,    -1,    -1,    10,     4,     5,     6,
       7,    -1,    -1,    10,     4,     5,     6,     7,     8
};
...
{
       0,     8,    16,     3,     5,     9,    11,    12,    13,    17,
       0,    17,    17,     9,     9,     9,     4,     5,     6,     7,
       8,    10,    17,    17,    17,    17,    17,    17,    17,    10,
      10,    14,    17,    10
};
