...
void create_svg(int a, int b, int c, int d)
{
	...
	print_rect(175, 25, 100, 25, "#ffffff","#000000", 2);
	...
	print_rect(175, 100, 100, 75, "#ffffff", "#000000", 2);
	print_text(228.12598, 112.67969, 12, "start","#000000", "none", 1, 228.12598, 112.67969, "Memory");
    fprintf(f, "\t\t</g>\n");
	print_path("M 100,100 L 130,115 L 130,155 L 100,170 L 100,140 L 110,135 L 100,130 L 100,100 z", "#ffffff", "#000000", 2);
	...
	print_rect(155.10001, 265, 94.900002, 59.716309,"#ffffff", "#000000", 1.99999988);
	...
	fprintf(f, "<path transform=\"matrix(1.0016064,0,0,1,-20.52208,22.5)\" d=\"M 375,237.5 A 25,37.5 0 1 1 325,237.5 A 25,37.5 0 1 1 375,237.5 z\" style=\"fill:#ffffff;stroke:#000000;stroke-width:1.99839556\" />");
	...
	print_rect(110, 440, 30, 40, "#ffffff", "#000000", 2);
	print_text(129.36816, 460.48569, 12, "middle", "#000000", "none", 1, 129.36816, 460.48569, "Zero?");
	fprintf(f, "</g>\n" );
	print_path("M 445,280 L 485,300 L 485,350 L 445,370 L 445,340 L 455,335 L 455,315 L 445,310 L 445,280 z", "#ffffff", "#000000", 2);
	print_text(329.28906, 470.33594, 12, "middle", "#000000", "none", 1, 329.28906, 470.33594, "ALU");
	fprintf(f, "<g ");
	print_transform(-59.250002,106);
	print_path("M 469.25,164 L 469.25,214 L 489.25,204 L 489.25,174 L 469.25,164 z", "#ffffff", "#000000", 2);
